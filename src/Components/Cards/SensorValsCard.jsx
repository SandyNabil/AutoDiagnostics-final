  ...
  return (
    <Card sx={{ bgcolor: 'primary.bgColor' }}>
      <CardContent sx={{ height: '22vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <Typography variant="h5" sx={{ color: "#ffcc00", fontFamily: 'Helvetica', fontWeight: 'bold', fontSize: { xs: '1.2rem', sm: '1.8rem' } }}>{sensorName}</Typography>
        <Typography variant="h4" sx={{ color, padding: '4px', fontWeight: 'bold', fontSize: { xs: '1.5rem', sm: '1.8rem' } }}>
          {value} {unit}
        </Typography>
