    ...
    const apiUrl = 'https://autodiagsystemtest.runasp.net/api/v1/car-systems/2/sensors/102';
    const apiUrl2 = 'https://autodiagsystemtest.runasp.net/api/v1/car-systems/2/sensors/102/readings';
    ...
    return (
        <SensorsStyle
            ...
            description="Timing Advance: This isn’t a single sensor, but part of the car’s brain that decides the best time to ignite the fuel in the engine. It makes these decisions based on how fast the engine is going, how much work it’s doing, and how hot it is, to keep the engine running smoothly.
