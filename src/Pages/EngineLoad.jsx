    ...
    const apiUrl = 'https://autodiagsystemtest.runasp.net/api/v1/car-systems/1/sensors/107';
    const apiUrl2 = 'https://autodiagsystemtest.runasp.net/api/v1/car-systems/1/sensors/107/readings';
    ...
    return (
        <SensorsStyle
            ...
            description="Also known as the Manifold Absolute Pressure (MAP) sensor, it measures the pressure in the engine's intake manifold. The ECU uses this data to control the fuel injection amount.
