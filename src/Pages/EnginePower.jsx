    ...
    const apiUrl = 'https://autodiagsystemtest.runasp.net/api/v1/car-systems/1/sensors/106';
    const apiUrl2 = 'https://autodiagsystemtest.runasp.net/api/v1/car-systems/1/sensors/106/readings';
    ...
    return (
        <SensorsStyle
            ...
            description="Engine Power Sensor: Also known as the engine oil pressure sensor, it measures the oil pressure in the engine."
