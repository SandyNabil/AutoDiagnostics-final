  ...
  <div style={{ padding: "20px", backgroundColor: "#15131e" }}>
    ...
    >
      <GaugeChart
        id="gauge-chart"
        nrOfLevels={30}
        percent={latestReading / maxValue} // Adjust the max value as needed
        textColor={getColor(latestReading, minValue, maxValue, avgValue)}
        formatTextValue={(value) => `${latestReading} RPM`}
      />
    </div>
    ...
    >
      ...
      >
        <p
          style={{
            color: "#e8e7e9",
            fontSize: isSmallScreen ? "2.5vh" : "3vh",
          }}
        >
          Min Value:{" "}
          <span
